...
//            webMercatorUtils: new WebMercatorUtils(),

//            initialize: function() {
//
//                this.url = 'http://maps.rosreestr.ru/arcgis/rest/services/Cadastre/CadastreOriginal/MapServer/0/';
//                this.query = 'query';
//                this.service = L.esri.Services.Service.extend({
//
//                });
//
//            },
...
//            getParams: function(latlng) {
//
////                var point = this.webMercatorUtils.LngLatToXY(latlng.lng, latlng.lat, true);
//
//                return {
//                    geometry: point[0] + ',' + point[1],
//                    where: '',
...
//
//
//                this.get(this.query, this.getParams(latlng), function(error, response){
//                    if(error) {
//                        callback.call(context, error);
//                    } else {
//                        console.log(response);
